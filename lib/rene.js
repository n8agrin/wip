(function() {
  ...
  rene.chart = function() {
    ...
    render = function() {
      var panelHeight, panelWidth, xLabel, xLabelEnter, yLabel, yLabelEnter;
  ...
  rene.NChart = (function() {
    ...
    NChart.prototype.setScale = function(aes, scale) {
      this.scales[aes] = scale;
      return this.originalScales[aes] = scale.copy();
    };

    NChart.prototype.setContainer = function(container) {
      this.container = d3.select(container);
      return this.setDimensionsFromSelection(container);
    };

    NChart.prototype.resetXYScales = function() {
      var scaleName, _i, _len, _ref, _results;
      _ref = ['x', 'y'];
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    NChart.prototype.initSVG = function(data) {
      var gEnter;
    ...
    NChart.prototype.initScales = function() {
    ...
    NChart.prototype.positionData = function(data) {
    ...
    NChart.prototype.initLayerGroups = function(data) {
    ...
    NChart.prototype.trainScaleRanges = function() {
      ...
      return (_ref3 = this.scales.y) != null ? _ref3.range([this.panelSize[1], 0]) : void 0;
    };

    NChart.prototype.trainScaleDomains = function(data) {
    ...
    NChart.prototype.renderLayers = function() {
      ...
      return this.layerGroups.each(function(data, i) {
        return d3.transition(d3.select(this)).call(layer([i]), scales, panelSize[0], panelSize[1]);
      });
    };

    NChart.prototype.renderScales = function() {
      var panelSize;
      panelSize = this.panelSize;
      if (this.scales.x) {
    ...
    NChart.prototype.renderGrid = function() {
      var panelSize;
      panelSize = this.panelSize;
      if (this.xGrid) {
    ...
    NChart.prototype.renderLabels = function() {
    ...
    NChart.prototype.initChart = function(data) {
      this.resetXYScales();
      this.initSVG(data);
      this.initScales();
    ...
    NChart.prototype.render = function() {
      this.renderLayers();
      this.renderScales();
      this.renderGrid();
    ...
    NChart.prototype.setDimensionsFromSelection = function(selection) {
    ...
    NChart.prototype.call = function() {
      return callable.apply(this, arguments);
    };

    NChart.prototype.apply = function() {
      return callable.apply(this, arguments);
    };
  ...
  rene.NLine = (function(_super) {
    ...
    NLine.prototype.render = function(group, scales) {
      var path;
    ...
    NLine.prototype.apply = function() {
