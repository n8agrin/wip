(function() {
  ...
  rene.Point = (function(_super) {
    ...
    function Point() {
      this.render = __bind(this.render, this);      Point.__super__.constructor.apply(this, arguments);
      this.defaultSize = 2;
    }
  ...
  rene.Line = (function(_super) {
    ...
    function Line() {
      this.render = __bind(this.render, this);      Line.__super__.constructor.apply(this, arguments);
  ...
  rene.Area = (function(_super) {
    ...
    function Area() {
      ...
      this.interpolate = d3.functor('cardinal');
      aes = this.aesthetics();
      aes.push(['y0', this.y0]);
      aes.push(['y1', this.y1]);
      this.aesthetics = function() {
        return aes;
      };
    }
  ...
  rene.Bar = (function(_super) {
    ...
    function Bar() {
      this.render = __bind(this.render, this);      Bar.__super__.constructor.apply(this, arguments);
  ...
  rene.Pie = (function(_super) {
    ...
    function Pie() {
      this.render = __bind(this.render, this);      this.location = 'center';
      this.locationMargin = 10;
