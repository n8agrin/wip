(function() {
  ...
  rene.chart = function() {
    var chart, group, layerDelay, layerDuration, layers, legend, mapData, margin, origScales, resetXYScales, scales, xAxis, xAxisLabel, yAxis, yAxisLabel;
    margin = {
      top: 20,
      bottom: 20,
      left: 30,
    ...
    group = function(data) {
      ...
      if ((_ref = data[0]) != null ? _ref.group : void 0) {
  ...
  rene.bar = function() {
    var barWidth, color, group, layer, move, padding, position, ranger, scales, step, x, y;
    scales = {
      x: d3.scale.ordinal,
      y: d3.scale.linear,
      color: d3.scale.category20
