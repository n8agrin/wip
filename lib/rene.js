...
(function() {
  ...
  rene.Chart = (function() {
    ...
    Chart.prototype.setScale = function(aes, scale) {
      ...
      return this.originalScales[aes] = scale.copy().domain(scale.domain().concat()).range(scale.range().concat());
    };
    ...
    Chart.prototype.resetXYScales = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.scales[scaleName] && this.originalScales[scaleName]) {
          _results.push(this.scales[scaleName] = this.originalScales[scaleName].copy());
        } else {
          _results.push(void 0);
        }
      }
  ...
  rene.Pie = (function(_super) {
    ...
    Pie.prototype.move = function(layer, width, height, margins) {
      switch (this.location) {
        ...
        case "left":
          return layer.attr("transform", rene.utils.translate((this.arc.outerRadius())(), height / 2));
      }
    };
