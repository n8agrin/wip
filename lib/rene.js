(function() {
  ...
  rene.bar = function() {
    var barWidth, layer, padding, ranger, scales, step, x, y;
    x = function(d) {
      return d[0];
    };
    y = function(d) {
    ...
    barWidth = function(scales) {
      ...
      if (scales.x.rangeBand) {
        ...
        return barWidth - padding(barWidth);
      }
    };
    scales = {
      x: d3.scale.ordinal,
    ...
    layer.barWidth = function(v) {
      var bandWidth;
      if (!(v != null)) return bandWidth;
      bandWidth = d3.functor(v);
      return layer;
    };
    layer.ranger = function(v) {
      if (!(v != null)) return ranger;
      ranger = d3.functor(v);
      return layer;
    };
    layer.step = function(v) {
      if (!(v != null)) return step;
      step = d3.functor(v);
      return layer;
    };
    layer.padding = function(v) {
      if (!(v != null)) return padding;
